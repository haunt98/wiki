...
- [Pop quiz: what time was it?](https://dave.cheney.net/2025/12/18/pop-quiz-what-time-was-it/2)

> In Go, the arguments to any function are evaluated before the function is called. When applied to defer statements,
> the second time.Now() is evaluated immediately, then printed after the delay.
...
```go
ctx, cancel := context.WithTimeoutCause(ctx, timeout, ErrGRPCServerTimeout)
defer cancel()

if ctxErr := context.Cause(ctx); ctxErr != nil {
    // May be log or do something
}
```
...
- [Protobuf Tip #8: Never use required](https://buf.build/blog/totw-8-never-use-required)
- [Protobuf Tip #9: Some numbers are more equal than others](https://buf.build/blog/totw-9-some-numbers-are-more-equal-than-others)
- [Protobuf Tip #10: Choosing the right integer type](https://buf.build/blog/choosing-the-right-protobuf-integer-type)
    - Just use int64 and move on with your life
- [Delta Encoding in Protobuf](https://buf.build/blog/delta-encoding-in-protobuf)
...
- [Writing a Go SQL driver](https://www.dolthub.com/blog/2026-01-23-golang-sql-drivers/)
...
- [Understanding Go's sync.Map from API to Hash Trie](https://victoriametrics.com/blog/go-sync-map-hash-trie/#3-before-you-reach-for-syncmap)
...
- [How Go detects struct copies with sync.noCopy](https://func25.dev/posts/go-sync-nocopy/)
...
- [Understanding the Go Runtime: Stacktraces](https://internals-for-interns.com/posts/go-runtime-stacktraces/)
...
- [Guest Posts: mmap vs pread in a real Go storage engine](https://internals-for-interns.com/posts/mmap-vs-pread-go-storage-engine/)
...
- [Zero-config Go heap profiling](https://coroot.com/blog/zero-config-go-heap-profiling/)
- [2025-06-28 – Golang and Let's Encrypt: a free software story](https://dotat.at/@/2025-06-28-boulder.html)
- [Profile-guided optimisation (PGO) on Grab services](https://engineering.grab.com/profile-guided-optimisation)
...
- [API Design: Optional Parameters](https://samwho.dev/blog/api-design-optional-parameters/)
- [API Design: Errors](https://samwho.dev/blog/api-design-errors/)
- [API Design: In The Wild](https://samwho.dev/blog/api-design-in-the-wild/)
- [API Design: In The Wild (part 2)](https://samwho.dev/blog/api-design-in-the-wild-part-2/)
...
- [The 14-Year Road to encoding/json/v2](https://www.ymotongpoo.com/books/go-json-v2-history/)
